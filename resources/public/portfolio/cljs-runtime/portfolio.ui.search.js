...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.first,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__51711){
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__51715){
var vec__51716 = p__51715;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51716,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51716,(1),null);
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51720_SHARP_){
return ((typeof p1__51720_SHARP_ === 'string') || ((p1__51720_SHARP_ instanceof cljs.core.Keyword)));
...
*/
portfolio.ui.search.t_portfolio$ui$search51721 = (function (index,meta51722){
this.index = index;
this.meta51722 = meta51722;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(portfolio.ui.search.t_portfolio$ui$search51721.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_51723,meta51722__$1){
var self__ = this;
var _51723__$1 = this;
return (new portfolio.ui.search.t_portfolio$ui$search51721(self__.index,meta51722__$1));
}));

(portfolio.ui.search.t_portfolio$ui$search51721.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_51723){
var self__ = this;
var _51723__$1 = this;
return self__.meta51722;
}));

(portfolio.ui.search.t_portfolio$ui$search51721.prototype.portfolio$ui$search$protocols$Index$ = cljs.core.PROTOCOL_SENTINEL);

(portfolio.ui.search.t_portfolio$ui$search51721.prototype.portfolio$ui$search$protocols$Index$index$arity$2 = (function (_,doc){
var self__ = this;
var ___$1 = this;
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(self__.index,portfolio.ui.search.index_scene,doc);
}));

(portfolio.ui.search.t_portfolio$ui$search51721.prototype.portfolio$ui$search$protocols$Index$query$arity$2 = (function (_,q){
var self__ = this;
var ___$1 = this;
return portfolio.ui.search.search(cljs.core.deref(self__.index),q);
}));

(portfolio.ui.search.t_portfolio$ui$search51721.getBasis = (function (){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"index","index",108845612,null),new cljs.core.Symbol(null,"meta51722","meta51722",-105043200,null)], null);
}));

(portfolio.ui.search.t_portfolio$ui$search51721.cljs$lang$type = true);

(portfolio.ui.search.t_portfolio$ui$search51721.cljs$lang$ctorStr = "portfolio.ui.search/t_portfolio$ui$search51721");

(portfolio.ui.search.t_portfolio$ui$search51721.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"portfolio.ui.search/t_portfolio$ui$search51721");
}));

/**
 * Positional factory function for portfolio.ui.search/t_portfolio$ui$search51721.
 */
portfolio.ui.search.__GT_t_portfolio$ui$search51721 = (function portfolio$ui$search$__GT_t_portfolio$ui$search51721(index,meta51722){
return (new portfolio.ui.search.t_portfolio$ui$search51721(index,meta51722));
});
...
return (new portfolio.ui.search.t_portfolio$ui$search51721(index,cljs.core.PersistentArrayMap.EMPTY));
});
...
,new cljs.core.Keyword(null,"actions","actions",-812656882),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"assoc-in","assoc-in",-1754117270),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("search","query","search/query",1830322034)], null),""], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"assoc-in","assoc-in",-1754117270),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("search","suggestions","search/suggestions",-1296554258)], null),null], null)], null)], null):null),new cljs.core.Keyword(null,"suggestions","suggestions",-859472618),(function (){var iter__5480__auto__ = (function portfolio$ui$search$prepare_search_$_iter__51724(s__51725){
return (new cljs.core.LazySeq(null,(function (){
var s__51725__$1 = s__51725;
while(true){
var temp__5823__auto__ = cljs.core.seq(s__51725__$1);
if(temp__5823__auto__){
var s__51725__$2 = temp__5823__auto__;
if(cljs.core.chunked_seq_QMARK_(s__51725__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__51725__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__51727 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__51726 = (0);
while(true){
if((i__51726 < size__5479__auto__)){
var result = cljs.core._nth(c__5478__auto__,i__51726);
cljs.core.chunk_append(b__51727,(((function (){var G__51728 = new cljs.core.Keyword(null,"index","index",-1531685915).cljs$core$IFn$_invoke$arity$1(state);
if((!((G__51728 == null)))){
if(((false) || ((cljs.core.PROTOCOL_SENTINEL === G__51728.portfolio$ui$search$protocols$SearchResult$)))){
return true;
} else {
if((!G__51728.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_(portfolio.ui.search.protocols.SearchResult,G__51728);
} else {
return false;
}
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__51727),portfolio$ui$search$prepare_search_$_iter__51724(cljs.core.chunk_rest(s__51725__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__51727),null);
}
} else {
var result = cljs.core.first(s__51725__$2);
return cljs.core.cons((((function (){var G__51729 = new cljs.core.Keyword(null,"index","index",-1531685915).cljs$core$IFn$_invoke$arity$1(state);
if((!((G__51729 == null)))){
if(((false) || ((cljs.core.PROTOCOL_SENTINEL === G__51729.portfolio$ui$search$protocols$SearchResult$)))){
return true;
} else {
if((!G__51729.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_(portfolio.ui.search.protocols.SearchResult,G__51729);
} else {
return false;
}
}
...
})())?portfolio.ui.search.protocols.prepare_result(new cljs.core.Keyword(null,"index","index",-1531685915).cljs$core$IFn$_invoke$arity$1(state),state,location,result):portfolio.ui.search.prepare_result(state,location,result)),portfolio$ui$search$prepare_search_$_iter__51724(cljs.core.rest(s__51725__$2)));
}
} else {
return null;
}
...
return iter__5480__auto__(cljs.core.take.cljs$core$IFn$_invoke$arity$2((6),new cljs.core.Keyword("search","suggestions","search/suggestions",-1296554258).cljs$core$IFn$_invoke$arity$1(state)));
})()], null);
});
