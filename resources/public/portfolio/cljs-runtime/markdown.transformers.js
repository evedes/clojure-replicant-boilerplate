...
var trimmed = (function (){var G__50193 = text;
if((G__50193 == null)){
return null;
} else {
return clojure.string.trim(G__50193);
}
})();
var and__5000__auto__ = cljs.core.not_empty(trimmed);
...
markdown.transformers.empty_line = (function markdown$transformers$empty_line(text,p__50194){
var map__50195 = p__50194;
var map__50195__$1 = cljs.core.__destructure_map(map__50195);
var state = map__50195__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50195__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50195__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_((function (){var or__5002__auto__ = markdown.transformers.h1_QMARK_(text);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
var G__50260 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq("<sup>"),cljs.core.second(remaining),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.seq("</sup>")], 0)));
var G__50261 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),remaining);
buf = G__50260;
remaining = G__50261;
continue;
} else {
var G__50263 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.first(remaining));
var G__50264 = cljs.core.rest(remaining);
buf = G__50263;
remaining = G__50264;
continue;
...
markdown.transformers.heading = (function markdown$transformers$heading(text,p__50196){
var map__50197 = p__50196;
var map__50197__$1 = cljs.core.__destructure_map(map__50197);
var state = map__50197__$1;
var buf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50197__$1,new cljs.core.Keyword(null,"buf","buf",-213913340));
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50197__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50197__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50197__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var heading_anchors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50197__$1,new cljs.core.Keyword(null,"heading-anchors","heading-anchors",1713527866));
if(cljs.core.truth_((function (){var or__5002__auto__ = codeblock;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return code;
...
if(cljs.core.truth_(markdown.transformers.h1_QMARK_((function (){var or__5002__auto__ = buf;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return next_line;
...
if(cljs.core.truth_(markdown.transformers.h2_QMARK_((function (){var or__5002__auto__ = buf;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return next_line;
...
markdown.transformers.br = (function markdown$transformers$br(text,p__50198){
var map__50199 = p__50198;
var map__50199__$1 = cljs.core.__destructure_map(map__50199);
var state = map__50199__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50199__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50199__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [" "," "], null),cljs.core.take_last((2),text))) && (cljs.core.not((function (){var or__5002__auto__ = code;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return lists;
...
markdown.transformers.autourl_transformer = (function markdown$transformers$autourl_transformer(text,p__50201){
var map__50202 = p__50201;
var map__50202__$1 = cljs.core.__destructure_map(map__50202);
var state = map__50202__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50202__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var frozen_strings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50202__$1,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.string.replace(text,/<https?:\/\/[-A-Za-z0-9+&@#\/%?=~_()|!:,.;]*[-A-Za-z0-9+&@#\/%=~_()|]>/,(function (p1__50200_SHARP_){
var vec__50203 = markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__50200_SHARP_,(1),(cljs.core.count(p1__50200_SHARP_) - (1))),cljs.core.deref(currently_frozen)], 0));
var url = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50203,(0),null);
var frozen_strings__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50203,(1),null);
...
return ["0",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50207)].join('');
} else {
return G__50207;
}
});
...
})())?text:clojure.string.replace(text,/<[\w._%+-]+@[\w.-]+\.[\w]{2,4}>/,(function (p1__50206_SHARP_){
var encoded = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2(encoder,cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__50206_SHARP_,(1),(cljs.core.count(p1__50206_SHARP_) - (1)))));
...
markdown.transformers.set_line_state = (function markdown$transformers$set_line_state(text,p__50208){
var map__50209 = p__50208;
var map__50209__$1 = cljs.core.__destructure_map(map__50209);
var state = map__50209__$1;
var inline_heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50209__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
...
if(cljs.core.truth_((function (){var and__5000__auto__ = cljs.core.not(last_line_empty_QMARK_);
...
markdown.transformers.open_paragraph = (function markdown$transformers$open_paragraph(text,p__50210){
var map__50211 = p__50210;
var map__50211__$1 = cljs.core.__destructure_map(map__50211);
var state = map__50211__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50211__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50211__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
var blockquote = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50211__$1,new cljs.core.Keyword(null,"blockquote","blockquote",372264190));
var heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50211__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var hr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50211__$1,new cljs.core.Keyword(null,"hr","hr",1377740067));
var temp = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50211__$1,new cljs.core.Keyword(null,"temp","temp",1791541284));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50211__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var inline_heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50211__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
var last_line_empty_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50211__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50211__$1,new cljs.core.Keyword(null,"code","code",1586293142));
if(cljs.core.truth_((function (){var and__5000__auto__ = paragraph;
if(cljs.core.truth_(and__5000__auto__)){
return lists;
} else {
return and__5000__auto__;
...
if(cljs.core.truth_((function (){var or__5002__auto__ = heading;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
var or__5002__auto____$1 = inline_heading;
if(cljs.core.truth_(or__5002__auto____$1)){
return or__5002__auto____$1;
} else {
var or__5002__auto____$2 = hr;
if(cljs.core.truth_(or__5002__auto____$2)){
return or__5002__auto____$2;
} else {
var or__5002__auto____$3 = code;
if(cljs.core.truth_(or__5002__auto____$3)){
return or__5002__auto____$3;
} else {
var or__5002__auto____$4 = lists;
...
if(cljs.core.truth_((function (){var or__5002__auto__ = eof;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
if(cljs.core.truth_((function (){var and__5000__auto__ = cljs.core.not(eof);
if(and__5000__auto__){
var and__5000__auto____$1 = (!(clojure.string.blank_QMARK_(text)));
if(and__5000__auto____$1){
var or__5002__auto__ = new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818).cljs$core$IFn$_invoke$arity$1(temp);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
markdown.transformers.close_paragraph = (function markdown$transformers$close_paragraph(text,p__50212){
var map__50213 = p__50212;
var map__50213__$1 = cljs.core.__destructure_map(map__50213);
var state = map__50213__$1;
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50213__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50213__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
if(cljs.core.truth_((function (){var and__5000__auto__ = paragraph;
if(cljs.core.truth_(and__5000__auto__)){
var G__50214 = next_line;
var G__50214__$1 = (((G__50214 == null))?null:clojure.string.trim(G__50214));
if((G__50214__$1 == null)){
return null;
} else {
return clojure.string.ends_with_QMARK_(G__50214__$1,"```");
}
} else {
return and__5000__auto__;
}
...
markdown.transformers.code = (function markdown$transformers$code(text,p__50215){
var map__50216 = p__50215;
var map__50216__$1 = cljs.core.__destructure_map(map__50216);
var state = map__50216__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50216__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var indent_code_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50216__$1,new cljs.core.Keyword(null,"indent-code-end","indent-code-end",644690061));
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50216__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50216__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50216__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50216__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50216__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
var should_close_QMARK_ = (function (){var or__5002__auto__ = eof;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
if(cljs.core.truth_((function (){var or__5002__auto__ = lists;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return codeblock;
...
if(cljs.core.truth_(code)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [[markdown.common.escape_code(clojure.string.replace_first(text,/    /,"\n")),(cljs.core.truth_(should_close_QMARK_)?"</code></pre>":null)].join(''),(function (){var G__50217 = state;
if(cljs.core.truth_(should_close_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50217,new cljs.core.Keyword(null,"indent-code-end","indent-code-end",644690061),true);
} else {
return G__50217;
}
})()], null);
...
if((num_spaces >= (4))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [["<pre><code>",markdown.common.escape_code(clojure.string.replace_first(text,/    /,"")),(cljs.core.truth_(should_close_QMARK_)?"</code></pre>":null)].join(''),(function (){var G__50218 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(state,new cljs.core.Keyword(null,"code","code",1586293142),true,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"indented-code","indented-code",-904930175),true], 0));
if(cljs.core.truth_(should_close_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50218,new cljs.core.Keyword(null,"indent-code-end","indent-code-end",644690061),true);
} else {
return G__50218;
}
})()], null);
...
markdown.transformers.codeblock = (function markdown$transformers$codeblock(text,p__50219){
var map__50220 = p__50219;
var map__50220__$1 = cljs.core.__destructure_map(map__50220);
var state = map__50220__$1;
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50220__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var codeblock_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50220__$1,new cljs.core.Keyword(null,"codeblock-end","codeblock-end",1507794736));
var indented_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50220__$1,new cljs.core.Keyword(null,"indented-code","indented-code",-904930175));
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50220__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50220__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var trimmed = clojure.string.trim(text);
var next_line_closes_QMARK_ = (function (){var G__50221 = next_line;
var G__50221__$1 = (((G__50221 == null))?null:clojure.string.trim(G__50221));
if((G__50221__$1 == null)){
return null;
} else {
return clojure.string.ends_with_QMARK_(G__50221__$1,"```");
}
})();
if(cljs.core.truth_((function (){var and__5000__auto__ = lists;
if(cljs.core.truth_(and__5000__auto__)){
...
if(cljs.core.truth_((function (){var and__5000__auto__ = next_line_closes_QMARK_;
if(cljs.core.truth_(and__5000__auto__)){
return codeblock;
} else {
return and__5000__auto__;
...
var vec__50222 = cljs.core.split_with(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.not_EQ_,"\n"),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((3),trimmed));
var lang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50222,(0),null);
var code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50222,(1),null);
 ...
 */
markdown.transformers.blockquote_1 = (function markdown$transformers$blockquote_1(text,p__50225){
var map__50226 = p__50225;
var map__50226__$1 = cljs.core.__destructure_map(map__50226);
var state = map__50226__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50226__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50226__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50226__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var trimmed = clojure.string.trim(text);
if(cljs.core.truth_((function (){var or__5002__auto__ = code;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
 ...
 */
markdown.transformers.blockquote_2 = (function markdown$transformers$blockquote_2(text,p__50227){
var map__50228 = p__50227;
var map__50228__$1 = cljs.core.__destructure_map(map__50228);
var state = map__50228__$1;
var blockquote_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50228__$1,new cljs.core.Keyword(null,"blockquote-start","blockquote-start",276074935));
var blockquote_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50228__$1,new cljs.core.Keyword(null,"blockquote-end","blockquote-end",1122544964));
var blockquote_paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50228__$1,new cljs.core.Keyword(null,"blockquote-paragraph","blockquote-paragraph",1931783682));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50228__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
...
if(cljs.core.truth_((function (){var and__5000__auto__ = blockquote_end;
if(cljs.core.truth_(and__5000__auto__)){
return not_in_list;
} else {
return and__5000__auto__;
...
return (function (p1__50229_SHARP_){
return ["<ol class='footnotes'>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50229_SHARP_),"</ol>"].join('');
})(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (footnotes__$1,p__50230){
var vec__50231 = p__50230;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50231,(0),null);
var label = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50231,(1),null);
...
var vec__50234 = cljs.core.re_matches(/^([0-9A-Za-z_-]*):(.*)$/,line);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50234,(0),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50234,(1),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50234,(2),null);
var vec__50237 = cljs.core.re_matches(/^    (.*)$/,line);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50237,(0),null);
var next_val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50237,(1),null);
...
var vec__50243 = ((cljs.core.sequential_QMARK_(data))?data:new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [prev_key,data], null));
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50243,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50243,(1),null);
...
var G__50277 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([acc,cljs.core.PersistentArrayMap.createAsIfByAssoc([key,new_val])], 0));
var G__50278 = cljs.core.rest(remain);
var G__50279 = key;
acc = G__50277;
remain = G__50278;
prev_key = G__50279;
