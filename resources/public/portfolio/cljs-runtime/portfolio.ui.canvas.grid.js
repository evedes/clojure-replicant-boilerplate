...
portfolio.ui.canvas.grid.prepare_canvas = (function portfolio$ui$canvas$grid$prepare_canvas(_data,el,p__51247){
var map__51248 = p__51247;
var map__51248__$1 = cljs.core.__destructure_map(map__51248);
var opt = map__51248__$1;
var offset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51248__$1,new cljs.core.Keyword("grid","offset","grid/offset",289189693));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51248__$1,new cljs.core.Keyword("grid","size","grid/size",1053670865));
var group_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51248__$1,new cljs.core.Keyword("grid","group-size","grid/group-size",-624518492));
var body_style = portfolio.ui.components.canvas.get_iframe(el).style;
var zoom = (function (){var or__5002__auto__ = new cljs.core.Keyword("zoom","level","zoom/level",1294076441).cljs$core$IFn$_invoke$arity$1(opt);
...
var vec__51252 = new cljs.core.Keyword("viewport","padding","viewport/padding",-1583726021).cljs$core$IFn$_invoke$arity$1(opt);
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51252,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51252,(1),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51252,(2),null);
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51252,(3),null);
(body_style.backgroundSize = (function (){var big = ((function (){var or__5002__auto__ = group_size;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return (5);
...
(body_style.backgroundPosition = (function (){var offset__$1 = (function (){var or__5002__auto__ = offset;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return (0);
...
,new cljs.core.Keyword(null,"default-value","default-value",232220170),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("grid","size","grid/size",1053670865),(0)], null),new cljs.core.Keyword(null,"options","options",99638489),(function (){var or__5002__auto__ = new cljs.core.Keyword("grid","options","grid/options",96459187).cljs$core$IFn$_invoke$arity$1(config);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
