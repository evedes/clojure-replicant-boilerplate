...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul","ul",-1349521403),attrs,(function (){var iter__5480__auto__ = (function portfolio$ui$components$browser$iter__50692(s__50693){
return (new cljs.core.LazySeq(null,(function (){
var s__50693__$1 = s__50693;
while(true){
var temp__5823__auto__ = cljs.core.seq(s__50693__$1);
if(temp__5823__auto__){
var s__50693__$2 = temp__5823__auto__;
if(cljs.core.chunked_seq_QMARK_(s__50693__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__50693__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__50695 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__50694 = (0);
while(true){
if((i__50694 < size__5479__auto__)){
var item = cljs.core._nth(c__5478__auto__,i__50694);
cljs.core.chunk_append(b__50695,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),(portfolio.ui.components.browser.render_menu.cljs$core$IFn$_invoke$arity$1 ? portfolio.ui.components.browser.render_menu.cljs$core$IFn$_invoke$arity$1(item) : portfolio.ui.components.browser.render_menu.call(null, item))], null));

var G__50746 = (i__50694 + (1));
i__50694 = G__50746;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__50695),portfolio$ui$components$browser$iter__50692(cljs.core.chunk_rest(s__50693__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__50695),null);
}
} else {
var item = cljs.core.first(s__50693__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),(portfolio.ui.components.browser.render_menu.cljs$core$IFn$_invoke$arity$1 ? portfolio.ui.components.browser.render_menu.cljs$core$IFn$_invoke$arity$1(item) : portfolio.ui.components.browser.render_menu.call(null, item))], null),portfolio$ui$components$browser$iter__50692(cljs.core.rest(s__50693__$2)));
}
} else {
return null;
}
...
var G__50700 = pair;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"folder","folder",1515881736),new cljs.core.Keyword(null,"folder","folder",1515881736)], null),G__50700)){
return (24);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"folder","folder",1515881736),new cljs.core.Keyword(null,"package","package",1189062786)], null),G__50700)){
return (0);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"package","package",1189062786),new cljs.core.Keyword(null,"folder","folder",1515881736)], null),G__50700)){
return (24);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"package","package",1189062786),new cljs.core.Keyword(null,"package","package",1189062786)], null),G__50700)){
return (24);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"folder","folder",1515881736),new cljs.core.Keyword(null,"unit","unit",375175175)], null),G__50700)){
return (8);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"package","package",1189062786),new cljs.core.Keyword(null,"unit","unit",375175175)], null),G__50700)){
return (48);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50700)].join('')));
 ...
 * 
 */
portfolio.ui.components.browser.Folder = (function (){var G__50718 = (function (p__50720){
var map__50723 = p__50720;
var map__50723__$1 = cljs.core.__destructure_map(map__50723);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50723__$1,new cljs.core.Keyword(null,"title","title",636505583));
var illustration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50723__$1,new cljs.core.Keyword(null,"illustration","illustration",-48860973));
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50723__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50723__$1,new cljs.core.Keyword(null,"items","items",1031954938));
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50723__$1,new cljs.core.Keyword(null,"context","context",-830191113));
...
var G__50719 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"name","name",1843675177),"portfolio.ui.components.browser/Folder"], null);
return (dumdom.core.component.cljs$core$IFn$_invoke$arity$2 ? dumdom.core.component.cljs$core$IFn$_invoke$arity$2(G__50718,G__50719) : dumdom.core.component.call(null, G__50718,G__50719));
})();
/**
 * 
 */
portfolio.ui.components.browser.Package = (function (){var G__50726 = (function (p__50728){
var map__50729 = p__50728;
var map__50729__$1 = cljs.core.__destructure_map(map__50729);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50729__$1,new cljs.core.Keyword(null,"title","title",636505583));
var illustration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50729__$1,new cljs.core.Keyword(null,"illustration","illustration",-48860973));
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50729__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
var toggle = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50729__$1,new cljs.core.Keyword(null,"toggle","toggle",1291842030));
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50729__$1,new cljs.core.Keyword(null,"items","items",1031954938));
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50729__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var selected_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50729__$1,new cljs.core.Keyword(null,"selected?","selected?",-742502788));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"background","background",-863952629),(cljs.core.truth_(selected_QMARK_)?"var(--highlight-bg)":null),new cljs.core.Keyword(null,"display","display",242065432),"flex",new cljs.core.Keyword(null,"align-items","align-items",-267946462),"center",new cljs.core.Keyword(null,"border-radius","border-radius",419594011),(4),new cljs.core.Keyword(null,"font-weight","font-weight",2085804583),(cljs.core.truth_(selected_QMARK_)?"bold":null),new cljs.core.Keyword(null,"padding-left","padding-left",-1180879053),((cljs.core.truth_(selected_QMARK_)?(4):(8)) + portfolio.ui.components.browser.get_context_offset(context,new cljs.core.Keyword(null,"package","package",1189062786))),new cljs.core.Keyword(null,"margin","margin",-995903681),(cljs.core.truth_(selected_QMARK_)?"0 4px":null)], null)], null),(cljs.core.truth_(new cljs.core.Keyword(null,"icon","icon",1679606541).cljs$core$IFn$_invoke$arity$1(toggle))?phosphor.icons.render.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"icon","icon",1679606541).cljs$core$IFn$_invoke$arity$1(toggle),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"size","size",1098693007),(16),new cljs.core.Keyword(null,"style","style",-496642736),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-right","margin-right",809689658),(8)], null),(function (){var temp__5823__auto__ = new cljs.core.Keyword(null,"rotation","rotation",-1728051644).cljs$core$IFn$_invoke$arity$1(toggle);
if(cljs.core.truth_(temp__5823__auto__)){
var rotation = temp__5823__auto__;
...
var G__50727 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"name","name",1843675177),"portfolio.ui.components.browser/Package"], null);
return (dumdom.core.component.cljs$core$IFn$_invoke$arity$2 ? dumdom.core.component.cljs$core$IFn$_invoke$arity$2(G__50726,G__50727) : dumdom.core.component.call(null, G__50726,G__50727));
})();
/**
 * 
 */
portfolio.ui.components.browser.Unit = (function (){var G__50730 = (function (p__50732){
var map__50733 = p__50732;
var map__50733__$1 = cljs.core.__destructure_map(map__50733);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50733__$1,new cljs.core.Keyword(null,"title","title",636505583));
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50733__$1,new cljs.core.Keyword(null,"url","url",276297046));
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50733__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
var selected_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50733__$1,new cljs.core.Keyword(null,"selected?","selected?",-742502788));
var illustration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50733__$1,new cljs.core.Keyword(null,"illustration","illustration",-48860973));
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50733__$1,new cljs.core.Keyword(null,"context","context",-830191113));
...
var G__50731 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"name","name",1843675177),"portfolio.ui.components.browser/Unit"], null);
return (dumdom.core.component.cljs$core$IFn$_invoke$arity$2 ? dumdom.core.component.cljs$core$IFn$_invoke$arity$2(G__50730,G__50731) : dumdom.core.component.call(null, G__50730,G__50731));
})();
portfolio.ui.components.browser.render_menu = (function portfolio$ui$components$browser$render_menu(props){
var G__50737 = new cljs.core.Keyword(null,"kind","kind",-717265803).cljs$core$IFn$_invoke$arity$1(props);
