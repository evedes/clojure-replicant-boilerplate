...
var i_40340 = (0);
while(true){
if((i_40340 < arr.length)){
(arr[i_40340] = null);

var G__40342 = (i_40340 + (1));
i_40340 = G__40342;
continue;
} else {
}
...
var i_40371 = (self__.level + (1));
while(true){
if((i_40371 <= (new_level + (1)))){
(update[i_40371] = self__.header);

var G__40372 = (i_40371 + (1));
i_40371 = G__40372;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_40373 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_40373[i]));
} else {
x__$2.forward.push((((i < links_40373.length))?(links_40373[i]):null));
}

if((i < links_40373.length)){
(links_40373[i] = x__$2);
} else {
links_40373.push(x__$2);
}
...
var i_40389 = (0);
while(true){
if((i_40389 <= self__.level)){
var links_40390 = (update[i_40389]).forward;
if((x__$1 === (((i_40389 < links_40390.length))?(links_40390[i_40389]):null))){
(links_40390[i_40389] = (x__$1.forward[i_40389]));

var G__40392 = (i_40389 + (1));
i_40389 = G__40392;
continue;
} else {
var G__40394 = (i_40389 + (1));
i_40389 = G__40394;
continue;
}
} else {
...
var G__40410 = nx;
var G__40411 = (level__$1 - (1));
x = G__40410;
level__$1 = G__40411;
continue;
} else {
var G__40412 = x;
var G__40413 = (level__$1 - (1));
x = G__40412;
level__$1 = G__40413;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__40440 = nx;
var G__40441 = (level__$1 - (1));
x = G__40440;
level__$1 = G__40441;
continue;
} else {
var G__40445 = x;
var G__40446 = (level__$1 - (1));
x = G__40445;
level__$1 = G__40446;
continue;
}
