...
return clojure.string.join.cljs$core$IFn$_invoke$arity$1((function (){var iter__5480__auto__ = (function markdown$lists$close_lists_$_iter__48864(s__48865){
return (new cljs.core.LazySeq(null,(function (){
var s__48865__$1 = s__48865;
while(true){
var temp__5823__auto__ = cljs.core.seq(s__48865__$1);
if(temp__5823__auto__){
var s__48865__$2 = temp__5823__auto__;
if(cljs.core.chunked_seq_QMARK_(s__48865__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__48865__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__48867 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__48866 = (0);
while(true){
if((i__48866 < size__5479__auto__)){
var vec__48872 = cljs.core._nth(c__5478__auto__,i__48866);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48872,(0),null);
cljs.core.chunk_append(b__48867,["</li></",cljs.core.name(list_type),">"].join(''));

var G__48912 = (i__48866 + (1));
i__48866 = G__48912;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__48867),markdown$lists$close_lists_$_iter__48864(cljs.core.chunk_rest(s__48865__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__48867),null);
}
} else {
var vec__48875 = cljs.core.first(s__48865__$2);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48875,(0),null);
return cljs.core.cons(["</li></",cljs.core.name(list_type),">"].join(''),markdown$lists$close_lists_$_iter__48864(cljs.core.rest(s__48865__$2)));
}
} else {
return null;
}
...
var lists_to_close = cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__48879_SHARP_){
return (cljs.core.second(p1__48879_SHARP_) > num_indents);
...
var vec__48885 = cljs.core.last(new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48885,(0),null);
var indents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48885,(1),null);
...
return markdown.lists.add_row(new cljs.core.Keyword(null,"ul","ul",-1349521403),list_type,num_indents,indents,(function (){var or__5002__auto__ = markdown.common.make_heading(content,false);
...
var vec__48891 = cljs.core.last(new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48891,(0),null);
var indents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48891,(1),null);
var num_indents = cljs.core.count(cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core._EQ_," "),text));
...
return markdown.lists.add_row(new cljs.core.Keyword(null,"ol","ol",932524051),list_type,num_indents,indents,(function (){var or__5002__auto__ = markdown.common.make_heading(content,false);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return content;
...
markdown.lists.li = (function markdown$lists$li(text,p__48901){
var map__48903 = p__48901;
var map__48903__$1 = cljs.core.__destructure_map(map__48903);
var state = map__48903__$1;
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48903__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var last_line_empty_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48903__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48903__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48903__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
if(cljs.core.truth_(codeblock)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [text,state], null);
} else {
if(cljs.core.truth_((function (){var and__5000__auto__ = last_line_empty_QMARK_;
...
var and__5000__auto____$1 = lists;
...
if(cljs.core.truth_((function (){var and__5000__auto__ = (function (){var or__5002__auto__ = eof;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
