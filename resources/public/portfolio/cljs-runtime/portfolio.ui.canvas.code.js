...
var G__51045 = state;
var G__51046 = view;
var G__51047 = (function (){var G__51048 = ctx;
if(cljs.core.not(portfolio.ui.canvas.code.show_code_QMARK_(state,tool,ctx))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__51048,new cljs.core.Keyword(null,"scenes","scenes",-425219404),(function (scenes){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51034_SHARP_){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(p1__51034_SHARP_,new cljs.core.Keyword(null,"code","code",1586293142));
}),scenes);
}));
} else {
return G__51048;
...
return (f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__51045,G__51046,G__51047) : f.call(null, G__51045,G__51046,G__51047));
...
var G__51049 = (f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(state,location,view) : f.call(null, state,location,view));
...
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__51049,new cljs.core.Keyword(null,"code","code",1586293142));
} else {
return G__51049;
}
})], null));
