...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(layout,new cljs.core.Keyword(null,"xs","xs",649443341),(function (p1__49886_SHARP_){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(portfolio.ui.layout.assign_pane_ids,p1__49886_SHARP_);
}));
} else {
...
var or__5002__auto__ = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"layout","layout",-2120940921),path], null));
...
var or__5002__auto__ = (function (){var temp__5823__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("canvas","layout","canvas/layout",-737151185),new cljs.core.Keyword(null,"scenes","scenes",-425219404).cljs$core$IFn$_invoke$arity$1(selection)));
...
var or__5002__auto____$1 = (function (){var temp__5823__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("canvas","layout","canvas/layout",-737151185),cljs.core.reverse(new cljs.core.Keyword(null,"path","path",-188191168).cljs$core$IFn$_invoke$arity$1(selection))));
if(cljs.core.truth_(temp__5823__auto__)){
var collection = temp__5823__auto__;
...
var or__5002__auto____$2 = (function (){var temp__5823__auto__ = new cljs.core.Keyword("canvas","layout","canvas/layout",-737151185).cljs$core$IFn$_invoke$arity$1(state);
if(cljs.core.truth_(temp__5823__auto__)){
var layout = temp__5823__auto__;
...
var or__5002__auto____$3 = (function (){var temp__5823__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("canvas","layout","canvas/layout",-737151185),new cljs.core.Keyword(null,"views","views",1450155487).cljs$core$IFn$_invoke$arity$1(state)));
if(cljs.core.truth_(temp__5823__auto__)){
...
if(cljs.core.truth_((function (){var G__49895 = new cljs.core.Keyword(null,"kind","kind",-717265803).cljs$core$IFn$_invoke$arity$1(layout);
var fexpr__49894 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"rows","rows",850049680),null,new cljs.core.Keyword(null,"cols","cols",-1914801295),null], null), null);
return (fexpr__49894.cljs$core$IFn$_invoke$arity$1 ? fexpr__49894.cljs$core$IFn$_invoke$arity$1(G__49895) : fexpr__49894.call(null, G__49895));
})())){
...
portfolio.ui.layout.get_layout_panes = (function portfolio$ui$layout$get_layout_panes(p__49902){
var map__49903 = p__49902;
var map__49903__$1 = cljs.core.__destructure_map(map__49903);
var layout = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49903__$1,new cljs.core.Keyword(null,"layout","layout",-2120940921));
