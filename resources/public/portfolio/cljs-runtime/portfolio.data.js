...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__46362){
var vec__46363 = p__46362;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46363,(0),null);
var scenes__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46363,(1),null);
return cljs.core.keep.cljs$core$IFn$_invoke$arity$2(cljs.core.second,cljs.core.drop_while.cljs$core$IFn$_invoke$arity$2((function (p__46369){
var vec__46370 = p__46369;
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46370,(0),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46370,(1),null);
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"line","line",212345235),(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"line","line",212345235).cljs$core$IFn$_invoke$arity$1(new$);
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"line","line",212345235).cljs$core$IFn$_invoke$arity$1(old),new cljs.core.Keyword(null,"idx","idx",1053688473),(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(old);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
var map__46414 = portfolio.data.get_scene_context(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(portfolio.data.scenes),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(scene)], null)),scene);
var map__46414__$1 = cljs.core.__destructure_map(map__46414);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46414__$1,new cljs.core.Keyword(null,"idx","idx",1053688473));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46414__$1,new cljs.core.Keyword(null,"line","line",212345235));
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(portfolio.data.scenes,cljs.core.assoc,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(scene),(function (){var G__46424 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(scene,new cljs.core.Keyword(null,"param","param",2013631823)),new cljs.core.Keyword(null,"line","line",212345235),line,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"idx","idx",1053688473),idx,new cljs.core.Keyword(null,"updated-at","updated-at",-1592622336),(new Date()).getTime()], 0));
var G__46424__$1 = ((cljs.core.empty_QMARK_(new cljs.core.Keyword(null,"title","title",636505583).cljs$core$IFn$_invoke$arity$1(scene)))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46424,new cljs.core.Keyword(null,"title","title",636505583),portfolio.homeless.__GT_title(cljs.core.name(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(scene)))):G__46424);
var G__46424__$2 = (((new cljs.core.Keyword(null,"collection","collection",-683361892).cljs$core$IFn$_invoke$arity$1(scene) == null))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46424__$1,new cljs.core.Keyword(null,"collection","collection",-683361892),(function (){var G__46435 = scene;
var G__46435__$1 = (((G__46435 == null))?null:new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(G__46435));
var G__46435__$2 = (((G__46435__$1 == null))?null:cljs.core.namespace(G__46435__$1));
if((G__46435__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__46435__$2);
}
})()):G__46424__$1);
if(cljs.core.truth_(new cljs.core.Keyword(null,"param","param",2013631823).cljs$core$IFn$_invoke$arity$1(scene))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46424__$2,new cljs.core.Keyword(null,"params","params",710516235),new cljs.core.Keyword(null,"param","param",2013631823).cljs$core$IFn$_invoke$arity$1(scene));
} else {
return G__46424__$2;
}
})());
...
var G__46515 = cljs.core.next(fs);
fs = G__46515;
continue;
} else {
return null;
