...
var G__51443 = (i__5727__auto___51439 + (1));
i__5727__auto___51439 = G__51443;
continue;
} else {
}
break;
...
return portfolio.ui.canvas.viewport.get_width.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),(arguments[(2)]),argseq__5733__auto__);
});

(portfolio.ui.canvas.viewport.get_width.cljs$core$IFn$_invoke$arity$variadic = (function (frame,frame_body,width,p__51322){
var vec__51323 = p__51322;
var map__51326 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51323,(0),null);
var map__51326__$1 = cljs.core.__destructure_map(map__51326);
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51326__$1,new cljs.core.Keyword("zoom","level","zoom/level",1294076441));
var level__$1 = (function (){var or__5002__auto__ = level;
...
/** @this {Function} */
(portfolio.ui.canvas.viewport.get_width.cljs$lang$applyTo = (function (seq51307){
var G__51308 = cljs.core.first(seq51307);
var seq51307__$1 = cljs.core.next(seq51307);
var G__51309 = cljs.core.first(seq51307__$1);
var seq51307__$2 = cljs.core.next(seq51307__$1);
var G__51310 = cljs.core.first(seq51307__$2);
var seq51307__$3 = cljs.core.next(seq51307__$2);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51308,G__51309,G__51310,seq51307__$3);
}));

portfolio.ui.canvas.viewport.get_style_px = (function portfolio$ui$canvas$viewport$get_style_px(style,prop){
var temp__5821__auto__ = (function (){var G__51343 = style;
var G__51343__$1 = (((G__51343 == null))?null:G__51343.getPropertyValue(prop));
if((G__51343__$1 == null)){
return null;
} else {
return cljs.core.not_empty(G__51343__$1);
}
})();
...
var args__5732__auto__ = [];
var len__5726__auto___51447 = arguments.length;
var i__5727__auto___51449 = (0);
while(true){
if((i__5727__auto___51449 < len__5726__auto___51447)){
args__5732__auto__.push((arguments[i__5727__auto___51449]));

var G__51450 = (i__5727__auto___51449 + (1));
i__5727__auto___51449 = G__51450;
continue;
} else {
}
break;
...
var argseq__5733__auto__ = ((((3) < args__5732__auto__.length))?(new cljs.core.IndexedSeq(args__5732__auto__.slice((3)),(0),null)):null);
return portfolio.ui.canvas.viewport.get_height.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),(arguments[(2)]),argseq__5733__auto__);
});

(portfolio.ui.canvas.viewport.get_height.cljs$core$IFn$_invoke$arity$variadic = (function (_frame,frame_body,height,p__51369){
var vec__51370 = p__51369;
var map__51373 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51370,(0),null);
var map__51373__$1 = cljs.core.__destructure_map(map__51373);
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51373__$1,new cljs.core.Keyword("zoom","level","zoom/level",1294076441));
var level__$1 = (function (){var or__5002__auto__ = level;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
/** @this {Function} */
(portfolio.ui.canvas.viewport.get_height.cljs$lang$applyTo = (function (seq51350){
var G__51351 = cljs.core.first(seq51350);
var seq51350__$1 = cljs.core.next(seq51350);
var G__51352 = cljs.core.first(seq51350__$1);
var seq51350__$2 = cljs.core.next(seq51350__$1);
var G__51353 = cljs.core.first(seq51350__$2);
var seq51350__$3 = cljs.core.next(seq51350__$2);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51351,G__51352,G__51353,seq51350__$3);
}));
...
portfolio.ui.canvas.viewport.prepare_canvas = (function portfolio$ui$canvas$viewport$prepare_canvas(_,el,p__51387){
var map__51388 = p__51387;
var map__51388__$1 = cljs.core.__destructure_map(map__51388);
var opt = map__51388__$1;
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51388__$1,new cljs.core.Keyword("viewport","width","viewport/width",809992237));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51388__$1,new cljs.core.Keyword("viewport","height","viewport/height",1951335772));
...
return (el.style.width = ((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("100%",w)) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2("100%",(function (){var or__5002__auto__ = height;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return "100%";
...
portfolio.ui.canvas.viewport.finalize_canvas = (function portfolio$ui$canvas$viewport$finalize_canvas(_,el,p__51400){
var map__51401 = p__51400;
var map__51401__$1 = cljs.core.__destructure_map(map__51401);
var opt = map__51401__$1;
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51401__$1,new cljs.core.Keyword("viewport","width","viewport/width",809992237));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51401__$1,new cljs.core.Keyword("viewport","height","viewport/height",1951335772));
var temp__5823__auto__ = portfolio.ui.components.canvas.get_iframe_body(el);
if(cljs.core.truth_(temp__5823__auto__)){
var frame_body = temp__5823__auto__;
var frame = portfolio.ui.components.canvas.get_iframe(el);
var w = portfolio.ui.canvas.viewport.get_width.cljs$core$IFn$_invoke$arity$variadic(frame,frame_body,width,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([opt], 0));
...
var vec__51403 = ((((((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2("100%",w)) || (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2("100%",height)))) && ((((!(typeof width === 'number'))) || ((((40) + width) < portfolio.ui.canvas.viewport.get_available_width(el)))))))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["20px","rgba(0, 0, 0, 0.1) 0px 1px 5px 0px"], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["0","none"], null));
var margin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51403,(0),null);
var shadow__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51403,(1),null);
(el.style.height = h);
...
var vec__51415 = xs__$1;
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51415,(0),null);
var h = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51415,(1),null);
...
var default_value = cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("viewport","defaults","viewport/defaults",2054751788).cljs$core$IFn$_invoke$arity$1(config),new cljs.core.Keyword("viewport","width","viewport/width",809992237),(function (p1__51418_SHARP_){
var or__5002__auto__ = p1__51418_SHARP_;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return "100%";
}
})),new cljs.core.Keyword("viewport","height","viewport/height",1951335772),(function (p1__51419_SHARP_){
var or__5002__auto__ = p1__51419_SHARP_;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return "100%";
...
,new cljs.core.Keyword(null,"default-value","default-value",232220170),default_value,new cljs.core.Keyword(null,"options","options",99638489),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51420_SHARP_){
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(p1__51420_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword("viewport","padding","viewport/padding",-1583726021)], null),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(portfolio.ui.canvas.viewport.get_padding,default_value));
}),(function (){var or__5002__auto__ = new cljs.core.Keyword("viewport","options","viewport/options",-576953325).cljs$core$IFn$_invoke$arity$1(config);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
