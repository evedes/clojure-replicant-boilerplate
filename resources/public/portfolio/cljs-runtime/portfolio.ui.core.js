...
portfolio.ui.core.sidebar_QMARK_ = (function portfolio$ui$core$sidebar_QMARK_(p__51731){
var map__51732 = p__51731;
var map__51732__$1 = cljs.core.__destructure_map(map__51732);
var state = map__51732__$1;
var sidebar_status = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51732__$1,new cljs.core.Keyword(null,"sidebar-status","sidebar-status",922425311));
...
var len__5726__auto___51744 = arguments.length;
var i__5727__auto___51745 = (0);
while(true){
if((i__5727__auto___51745 < len__5726__auto___51744)){
args__5732__auto__.push((arguments[i__5727__auto___51745]));

var G__51746 = (i__5727__auto___51745 + (1));
i__5727__auto___51745 = G__51746;
continue;
} else {
}
break;
...
return portfolio.ui.core.prepare_scene_browser.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5733__auto__);
});

(portfolio.ui.core.prepare_scene_browser.cljs$core$IFn$_invoke$arity$variadic = (function (state,location,p__51736){
var vec__51737 = p__51736;
var map__51740 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51737,(0),null);
var map__51740__$1 = cljs.core.__destructure_map(map__51740);
var select_actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51740__$1,new cljs.core.Keyword(null,"select-actions","select-actions",-859150860));
...
/** @this {Function} */
(portfolio.ui.core.prepare_scene_browser.cljs$lang$applyTo = (function (seq51733){
var G__51734 = cljs.core.first(seq51733);
var seq51733__$1 = cljs.core.next(seq51733);
var G__51735 = cljs.core.first(seq51733__$1);
var seq51733__$2 = cljs.core.next(seq51733__$1);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51734,G__51735,seq51733__$2);
}));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51741,new cljs.core.Keyword(null,"selected?","selected?",-742502788),true);
} else {
return G__51741;
}
});
...
var G__51743 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"small?","small?",95242445),portfolio.ui.screen.small_screen_QMARK_(state__$1),new cljs.core.Keyword(null,"tab-bar","tab-bar",-787971209),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tabs","tabs",-779855354),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51742_SHARP_){
return portfolio.ui.core.prepare_view_option(current_view,p1__51742_SHARP_);
...
if(scenes_QMARK_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__51743,new cljs.core.Keyword(null,"header","header",119441134),portfolio.ui.core.prepare_header(state__$1,location),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"sidebar","sidebar",35784458),portfolio.ui.core.prepare_sidebar(state__$1,location)], 0));
} else {
return G__51743;
}
});
