...
var or__5002__auto__ = (!(cljs.core.contains_QMARK_(component_state,new cljs.core.Keyword(null,"data","data",-232669377))));
if(or__5002__auto__){
return or__5002__auto__;
} else {
var or__5002__auto____$1 = cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(component_state),data);
if(or__5002__auto____$1){
return or__5002__auto____$1;
} else {
var and__5000__auto__ = dumdom.component._STAR_render_eagerly_QMARK__STAR_;
...
dumdom.component.setup_animation_hooks = (function dumdom$component$setup_animation_hooks(rendered,animation,p__47970){
var map__47971 = p__47970;
var map__47971__$1 = cljs.core.__destructure_map(map__47971);
var will_enter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47971__$1,new cljs.core.Keyword(null,"will-enter","will-enter",-692415624));
var will_appear = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47971__$1,new cljs.core.Keyword(null,"will-appear","will-appear",579342096));
...
var G__47972 = rendered;
var G__47972__$1 = (cljs.core.truth_(will_enter)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47972,new cljs.core.Keyword(null,"willEnter","willEnter",-70990441),(function (){
...
if(cljs.core.truth_(will_appear)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47972__$1,new cljs.core.Keyword(null,"willAppear","willAppear",-1052339861),(function (){
...
dumdom.component.setup_mount_hook = (function dumdom$component$setup_mount_hook(rendered,p__47976,data,args,animation){
var map__47977 = p__47976;
var map__47977__$1 = cljs.core.__destructure_map(map__47977);
var on_mount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47977__$1,new cljs.core.Keyword(null,"on-mount","on-mount",-1236735840));
var on_render = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47977__$1,new cljs.core.Keyword(null,"on-render","on-render",2096729391));
var will_appear = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47977__$1,new cljs.core.Keyword(null,"will-appear","will-appear",579342096));
var did_appear = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47977__$1,new cljs.core.Keyword(null,"did-appear","did-appear",2048737572));
var will_enter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47977__$1,new cljs.core.Keyword(null,"will-enter","will-enter",-692415624));
var did_enter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47977__$1,new cljs.core.Keyword(null,"did-enter","did-enter",-1814731189));
var G__47978 = rendered;
if(cljs.core.truth_((function (){var or__5002__auto__ = on_mount;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
var or__5002__auto____$1 = on_render;
if(cljs.core.truth_(or__5002__auto____$1)){
return or__5002__auto____$1;
} else {
var or__5002__auto____$2 = will_enter;
...
var map__47988 = cljs.core.deref(animation);
var map__47988__$1 = cljs.core.__destructure_map(map__47988);
var will_enter__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47988__$1,new cljs.core.Keyword(null,"will-enter","will-enter",-692415624));
var will_appear__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47988__$1,new cljs.core.Keyword(null,"will-appear","will-appear",579342096));
var temp__5823__auto__ = (function (){var or__5002__auto__ = will_enter__$1;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
var temp__5823__auto____$1 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(callback,will_enter__$1))?did_enter:did_appear);
if(cljs.core.truth_(temp__5823__auto____$1)){
var completion = temp__5823__auto____$1;
...
dumdom.component.setup_update_hook = (function dumdom$component$setup_update_hook(rendered,p__47998,data,old_data,args){
var map__47999 = p__47998;
var map__47999__$1 = cljs.core.__destructure_map(map__47999);
var on_update = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47999__$1,new cljs.core.Keyword(null,"on-update","on-update",1680216496));
var on_render = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47999__$1,new cljs.core.Keyword(null,"on-render","on-render",2096729391));
var G__48000 = rendered;
if(cljs.core.truth_((function (){var or__5002__auto__ = on_update;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return on_render;
...
var G__48006 = rendered;
var G__48006__$1 = cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__48006,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data","data",-232669377),new cljs.core.Keyword(null,"hook","hook",750265408),new cljs.core.Keyword(null,"destroy","destroy",-843660405)], null),(function (destroy_hook){
return (function (vnode){
var temp__5823__auto___48122 = new cljs.core.Keyword(null,"on-unmount","on-unmount",245689269).cljs$core$IFn$_invoke$arity$1(component);
if(cljs.core.truth_(temp__5823__auto___48122)){
var on_unmount_48123 = temp__5823__auto___48122;
cljs.core.apply.cljs$core$IFn$_invoke$arity$4(on_unmount_48123,vnode.elm,data,args);
} else {
}
...
return cljs.core.assoc_in(G__48006__$1,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data","data",-232669377),new cljs.core.Keyword(null,"hook","hook",750265408),new cljs.core.Keyword(null,"remove","remove",-131428414)], null),(function (vnode,snabbdom_callback){
var callback = (function (){
var temp__5823__auto___48124 = new cljs.core.Keyword(null,"did-leave","did-leave",1577156642).cljs$core$IFn$_invoke$arity$1(component);
if(cljs.core.truth_(temp__5823__auto___48124)){
var did_leave_48125 = temp__5823__auto___48124;
cljs.core.apply.cljs$core$IFn$_invoke$arity$4(did_leave_48125,vnode.elm,data,args);
} else {
}
...
var k = dumdom.element.enumerate_key(kmap,clojure.string.join.cljs$core$IFn$_invoke$arity$2(".",cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.empty_QMARK_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [component_name,cljs.core.str.cljs$core$IFn$_invoke$arity$1(keyfn_key),(function (){var G__48030 = new cljs.core.Keyword("dumdom","component-key","dumdom/component-key",-1206270376).cljs$core$IFn$_invoke$arity$1(rendered);
if((G__48030 == null)){
return null;
} else {
return cljs.core.first(G__48030);
}
})()], null))));
...
var component_name = (function (){var or__5002__auto__ = new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(opt);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
var or__5002__auto____$1 = cljs.core.not_empty(render.name);
if(cljs.core.truth_(or__5002__auto____$1)){
return or__5002__auto____$1;
} else {
...
return (function() { 
var G__48129__delegate = function (data,args){
var comp_fn = (function (path,kmap){
var key = (function (){var temp__5823__auto__ = new cljs.core.Keyword(null,"keyfn","keyfn",780060332).cljs$core$IFn$_invoke$arity$1(opt);
if(cljs.core.truth_(temp__5823__auto__)){
var keyfn = temp__5823__auto__;
...
var instance = (function (){var fexpr__48049 = cljs.core.deref(instances);
return (fexpr__48049.cljs$core$IFn$_invoke$arity$1 ? fexpr__48049.cljs$core$IFn$_invoke$arity$1(fullpath) : fexpr__48049.call(null, fullpath));
})();
...
var rendered = (function (){var G__48053 = (function (){var temp__5823__auto__ = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(render,data,args);
if(cljs.core.truth_(temp__5823__auto__)){
var vdom = temp__5823__auto__;
var G__48055 = fullpath;
var G__48056 = cljs.core.PersistentArrayMap.EMPTY;
var fexpr__48054 = dumdom.element.inflate_hiccup(vdom);
...
var G__48053__$1 = (((G__48053 == null))?null:dumdom.component.resolve_key(G__48053,component_name,key,kmap));
var G__48053__$2 = (((G__48053__$1 == null))?null:cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__48053__$1,new cljs.core.Keyword("dumdom","render-comments?","dumdom/render-comments?",877432722),dumdom.component._STAR_render_comments_QMARK__STAR_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("dumdom","lookup-key","dumdom/lookup-key",234912017),lookup_key], 0)));
var G__48053__$3 = (((G__48053__$2 == null))?null:cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__48053__$2,new cljs.core.Keyword("dumdom","component-name","dumdom/component-name",19850734),(function (s){
...
var G__48053__$4 = (((G__48053__$3 == null))?null:dumdom.component.setup_animation_hooks(G__48053__$3,animation,opt));
if((G__48053__$4 == null)){
return null;
} else {
return dumdom.component.setup_unmount_hook(G__48053__$4,opt,data,args,animation,(function (){
...
var G__48058 = rendered;
var G__48058__$1 = (cljs.core.truth_(rendered)?dumdom.component.setup_mount_hook(G__48058,opt,data,args,animation):G__48058);
if(cljs.core.truth_((function (){var and__5000__auto__ = rendered;
if(cljs.core.truth_(and__5000__auto__)){
return instance;
} else {
return and__5000__auto__;
...
return dumdom.component.setup_update_hook(G__48058__$1,opt,data,new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(instance),args);
} else {
return G__48058__$1;
}
} else {
...
var G__48129 = function (data,var_args){
var args = null;
...
while (G__48131__i < G__48131__a.length) {G__48131__a[G__48131__i] = arguments[G__48131__i + 1]; ++G__48131__i;}
  args = new cljs.core.IndexedSeq(G__48131__a,0,null);
} 
return G__48129__delegate.call(this,data,args);};
G__48129.cljs$lang$maxFixedArity = 1;
G__48129.cljs$lang$applyTo = (function (arglist__48132){
var data = cljs.core.first(arglist__48132);
var args = cljs.core.rest(arglist__48132);
return G__48129__delegate(data,args);
});
...
var fexpr__48067 = new cljs.core.Keyword(null,"component","component",1555936782).cljs$core$IFn$_invoke$arity$1(opt);
return (fexpr__48067.cljs$core$IFn$_invoke$arity$1 ? fexpr__48067.cljs$core$IFn$_invoke$arity$1(children__$1) : fexpr__48067.call(null, children__$1));
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(el_fn,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"component","component",1555936782).cljs$core$IFn$_invoke$arity$1(opt);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return "span";
...
dumdom.component.animate = (function dumdom$component$animate(transition,p__48072){
var map__48073 = p__48072;
var map__48073__$1 = cljs.core.__destructure_map(map__48073);
var enabled_by_default_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48073__$1,new cljs.core.Keyword(null,"enabled-by-default?","enabled-by-default?",-973479851));
...
return (function (node,callback,p__48074){
var map__48075 = p__48074;
var map__48075__$1 = cljs.core.__destructure_map(map__48075);
var props = map__48075__$1;
var transitionName = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48075__$1,new cljs.core.Keyword(null,"transitionName","transitionName",-654288740));
...
var vec__48076 = dumdom.component.transition_classes(transitionName,transition.toLowerCase());
var init_class = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48076,(0),null);
var active_class = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48076,(1),null);
...
return (function (node,p__48082){
var map__48083 = p__48082;
var map__48083__$1 = cljs.core.__destructure_map(map__48083);
var transitionName = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48083__$1,new cljs.core.Keyword(null,"transitionName","transitionName",-654288740));
...
dumdom.component.TransitioningElement = dumdom.component.component.cljs$core$IFn$_invoke$arity$2((function (p__48088){
var map__48089 = p__48088;
var map__48089__$1 = cljs.core.__destructure_map(map__48089);
var child = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48089__$1,new cljs.core.Keyword(null,"child","child",623967545));
return child;
...
var children__$1 = ((dumdom.component.single_child_QMARK_(children))?(new cljs.core.List(null,children,null,(1),null)):cljs.core.seq(children));
return dumdom.component.TransitionGroup(el_fn,opt,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48090_SHARP_){
return dumdom.component.TransitioningElement(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(opt,new cljs.core.Keyword(null,"child","child",623967545),p1__48090_SHARP_));
}),children__$1));
});
dumdom.component.component_QMARK_ = (function dumdom$component$component_QMARK_(x){
var and__5000__auto__ = x;
if(cljs.core.truth_(and__5000__auto__)){
return x.dumdom;
} else {
return and__5000__auto__;
