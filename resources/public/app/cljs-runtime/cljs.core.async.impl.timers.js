...
var i_31145 = (0);
while(true){
if((i_31145 < arr.length)){
(arr[i_31145] = null);

var G__31149 = (i_31145 + (1));
i_31145 = G__31149;
continue;
} else {
}
...
var i_31180 = (self__.level + (1));
while(true){
if((i_31180 <= (new_level + (1)))){
(update[i_31180] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_31185 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_31185[i]));
} else {
x__$2.forward.push((((i < links_31185.length))?(links_31185[i]):null));
}

if((i < links_31185.length)){
(links_31185[i] = x__$2);
} else {
links_31185.push(x__$2);
}
...
var i_31190 = (0);
while(true){
if((i_31190 <= self__.level)){
var links_31191 = (update[i_31190]).forward;
if((x__$1 === (((i_31190 < links_31191.length))?(links_31191[i_31190]):null))){
(links_31191[i_31190] = (x__$1.forward[i_31190]));

var G__31194 = (i_31190 + (1));
i_31190 = G__31194;
continue;
} else {
var G__31197 = (i_31190 + (1));
i_31190 = G__31197;
continue;
}
} else {
...
var G__31208 = nx;
var G__31209 = (level__$1 - (1));
x = G__31208;
level__$1 = G__31209;
continue;
} else {
var G__31211 = x;
var G__31212 = (level__$1 - (1));
x = G__31211;
level__$1 = G__31212;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__31223 = nx;
var G__31224 = (level__$1 - (1));
x = G__31223;
level__$1 = G__31224;
continue;
} else {
var G__31225 = x;
var G__31226 = (level__$1 - (1));
x = G__31225;
level__$1 = G__31226;
continue;
}
