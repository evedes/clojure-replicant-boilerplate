...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_30618 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_30618(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_30621 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_30621(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_30626 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_30626(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_30633 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_30633(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_30636 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_30636(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_30638 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_30638(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__30611,callback){
var map__30613 = p__30611;
var map__30613__$1 = cljs.core.__destructure_map(map__30613);
var input = map__30613__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30613__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30613__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
